...
#define KR6_Pin GPIO_PIN_1
#define KR6_GPIO_Port GPIOC
#define USART2_TX_Pin GPIO_PIN_2
#define USART2_TX_GPIO_Port GPIOA
#define USART2_RX_Pin GPIO_PIN_3
#define USART2_RX_GPIO_Port GPIOA
#define KR8_Pin GPIO_PIN_5
#define KR8_GPIO_Port GPIOA
#define KR7_Pin GPIO_PIN_6
#define KR7_GPIO_Port GPIOA
#define KR5_Pin GPIO_PIN_0
#define KR5_GPIO_Port GPIOB
#define KR3_Pin GPIO_PIN_2
#define KR3_GPIO_Port GPIOB
#define KR1_Pin GPIO_PIN_14
#define KR1_GPIO_Port GPIOB
#define KR4_Pin GPIO_PIN_7
#define KR4_GPIO_Port GPIOC
